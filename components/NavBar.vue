  ...
  <nav class="px-4 sm:px-4 py-8">
    <div class="container flex flex-wrap justify-between items-center mx-auto font-spacegrotesk">
      ...
      <div class="flex md:order-2">
        <a href="mailto:rupert.brandstaetter@gmail.com" class="text-white bg-rose-500 hover:bg-rose-800 focus:ring-4 focus:ring-rose-300 px-3 py-2 hover:py-3 transition-all text-center mr-3 dark:bg-rose-500 dark:hover:bg-rose-700 dark:focus:ring-rose-800">
          Kontaktiere mich!
        </a>
        <button
      ...
      <div id="mobile-menu" class="justify-between items-center w-full md:flex md:w-auto md:order-1" :class="{ hidden : !isOpen}">
        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
          ...
          <li>
            <NuxtLink to="/blog" href="#" class="block text-lg py-2 pr-4 pl-3 text-zinc-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-rose-600 md:p-0 md:dark:hover:text-white dark:text-zinc-50 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 transition-all">
              Blog
            </NuxtLink>
          </li>
        </ul>
